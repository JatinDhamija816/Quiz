                ...
                {showResult ? (
                    ...
                    <>
                        ...
                        <div className="">
                            ...
                            (
                                <div className='border m-3 w-1/3 mx-auto rounded-lg'>
                                    <button className={`w-full rounded-lg ${clickedOption == i + 1 ? "bg-blue-500 text-white border-none" : null}`}
                                        key={i}
                        ...
                        <div className='bg-black text-white w-1/5 mx-auto m-5 rounded-lg hover:cursor-pointer'>
                            <input type="button" value="Next" id="next-button" onClick={changeQuestion} className='hover:cursor-pointer' />
                        </div>
                    </>)}
            </div>
        </div>
